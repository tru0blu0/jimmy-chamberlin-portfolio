export const data = {
  ...
  caseStudies: [
    {
      ...
      wouldDoDifferently: 'Today I\'d deploy an AI-powered carrier onboarding pipeline: LLM-based document extraction from carrier packets (insurance certs, W-9s, authority records) to auto-populate the TMS, automated compliance monitoring that cross-references SaferWatch data against carrier profiles daily, and a multi-agent workflow where one agent vets carriers, another flags compliance anomalies, and a third generates onboarding checklists. Fleet MDM would use AI-driven anomaly detection for driver behavior and predictive maintenance. Carrier vetting and compliance monitoring — currently manual spreadsheet work — would shift to automated agent workflows that continuously audit carrier authority, insurance status, and safety scores against FMCSA databases, flagging risks before they become violations.',
    },
    {
      id: 'restaurant',
  ...
  credibilityMarquee: [
    ...
    'Invoice Reconciliation',
    '·',
    '2,561 Invoices Reconciled',
    '·',
    'VehicHaul TMS',
    '·',
    'AscendTMS → VehicHaul Migration',
    '·',
    'BigRoad ELD',
    '·',
    'Samsung Knox MDM',
    ...
    'Multi-Vendor Sourcing',
    '·',
    'GFS + Sysco Dual-Vendor Strategy',
    '·',
    'Labor Scheduling',
    '·',
    '29-Person Staffing Model',
    '·',
    'SOP Development',
    '·',
    'PracticePanther',
    ...
    '·',
    '300–400+ Workstation Deployments',
    '·',
