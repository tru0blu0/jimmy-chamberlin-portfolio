...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} className="py-28 md:py-36 relative">
      <div
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10 lg:px-16">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            <h2 className="text-display-md font-display font-extrabold text-text-primary mb-8 leading-none">
              Operations is{' '}
          ...
          >
            ...
            <div className="mt-10 p-6 border border-amber-base/20 rounded-lg bg-amber-base/[0.03]">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 border border-amber-base/30 rounded-sm flex items-center justify-center shrink-0">
                  <svg viewBox="0 0 24 24" fill="none" stroke="#D4860A" strokeWidth="1.5" className="w-5 h-5">
